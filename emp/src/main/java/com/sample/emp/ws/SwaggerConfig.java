...
public class SwaggerConfig
{
	...
	Contact contact = new Contact("Raji", "http://localhost:8080/user-app-ws/v2/api-docs", "rajeshwari@cintap.com");
	...
	public Docket api()
	{
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors.basePackage("com.sample.emp.controller"))
